...
import type { OrderSummary as _OrderSummary } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async addProduct(arg0: string, arg1: string, arg2: number, arg3: Array<string>): Promise<bigint> {
    ...
    async calculateOrderSummary(arg0: string | null): Promise<OrderSummary> {
        if (this.processError) {
            try {
                const result = await this.actor.calculateOrderSummary(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0));
                return from_candid_OrderSummary_n2(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async validateCoupon(arg0: string): Promise<number | null> {
        if (this.processError) {
            try {
...
function from_candid_OrderSummary_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _OrderSummary): OrderSummary {
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        couponCode: record_opt_to_undefined(from_candid_opt_n4(_uploadFile, _downloadFile, value.couponCode)),
        total: value.total,
